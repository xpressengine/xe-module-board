...
//            return new Object();
		...
		function _makeListColumnList()
		{
			...
			$defaultColumn = array('document_srl', 'module_srl', 'category_srl', 'member_srl', 'last_update', 'comment_count', 'trackback_count', 'uploaded_count', 'status', 'regdate', 'ipaddress', 'title_bold', 'title_color', 'comment_status');
